...
function init (_socket, _package) {
  ...
  setComputedOptions(_socket, _package);

  // check common options
  validation.commonOptions(_socket.config);

  // apply the requested socket model: client or server
  applyModel(_socket, _package);

  return _socket;
}

function setComputedOptions (_socket, _package) {
...
exports.init               = init;
exports.setComputedOptions = setComputedOptions;
